...
$(document).ready(function() {
    ...
    $('#tambah').submit(function(event) {
        message = null;
        if(train_data.name && train_data.telpon && train_data.alamat && train_data.file ) {
            ...
            axios.post('/tambah_karyawan', train_form_data).then(function(response) {
    ...
    $('#recognize').submit(function(e){
        ...
        axios.post('/absenMasuk', recog_form_data).then(function(response){
